...
export default function Home() {
  ...
  return <div className="app-shell">
    ...
    <main id="overview" className="main-content">
      ...
      <div className="work-notice"><span className="next-label">IN FOCUS</span><div><strong>One coherent Meadows scene.</strong><span> Grass, beech and dandelion candidates have scoped evidence. World integration and complete scene review are next.</span></div><a href="#milestones" aria-label="View current milestones"><ArrowUpRight size={20}/></a></div>
